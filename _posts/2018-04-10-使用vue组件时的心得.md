...
![](https://github.com/yangliangwu/my-blog/blob/master/assets/img/blog-pic/vue使用心得1.PNG '增加了div等标签的class选择器')

![](https://github.com/yangliangwu/my-blog/blob/master/assets/img/blog-pic/vue使用心得2.PNG '增加了样式的选择器')
